...
This role configures the authorized_keys and known_hosts file for a specific 
user. The role assumes that the root user has been previously configured for
access over ssh.
