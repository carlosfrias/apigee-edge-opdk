...
This role provides a set of default variables and modules for installing Apigee On Premise Private Cloud. This roles is 
a dependency to every other role. 
...
--------------
    ...
    # Apigee bootstrap script location
    ...
    #--------------------------------
    # Baas Default Variables, this section could be a candidate for
    # export into another role just for Baas defaults.
    ...
    baas_admin_name: 'baas_admin'
    baas_admin_email: '{{ baas_admin_name }}@apigee.com'
    baas_admin_pass: '{{ opdk_user_pass }}'
    baas_superuser_name: 'superuser'
    baas_superuser_email: 'superuser@apigee.com'
    baas_superuser_pass: '{{ opdk_user_pass }}'
    ...
    opdk_cass_username: '{{ opdk_user_name }}'
    # Default value
    ...
    baas_smtp_port: '465'
    baas_smtp_user: '{{ baas_admin_email }}'
    baas_smtp_user_pass: '{{ baas_admin_pass }}'
    baas_smtp_ssl: 'n'
