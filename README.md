# Apigee Edge OPDK Roles

This is a set of Ansible roles that are used for working with Apigee Edge
OPDK instances.  
These are Ansible roles that are used to setup and install OPDK 15.07.xx. 
